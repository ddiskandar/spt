    ...
    public function mount()
    {
        ...
        $this->data = [
            ...
            'bekerja' => [
                ...
                'bukan_dudika' => Trace::whereHas('student', function ($query) { $query->where('year_id', $this->year); })->with('student')->where('activity_id', 2)->whereNotNull('dudika_id')->count(),
                'masa_tunggu' => round(Trace::whereHas('student', function ($query) { $query->where('year_id', $this->year); })->with('student')->where('activity_id', 2)->avg('bekerja_masa_tunggu')),
