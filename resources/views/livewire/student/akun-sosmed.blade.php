    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 md:col-span-4">
            ...
            <div class="relative flex items-center">
                <x-jet-input id="state.facebook" wire:model.defer="state.facebook" class="relative block w-full mt-2 pl-44" type="text" name="state.facebook" />
        ...
        <div class="col-span-6 md:col-span-4">
            ...
            <div class="relative flex items-center">
                <x-jet-input id="state.instagram" wire:model.defer="state.instagram" class="relative block w-full mt-2 pl-44 " type="text" name="state.instagram" />
        ...
        <div class="col-span-6 md:col-span-4">
            ...
            <div class="relative flex items-center">
                <x-jet-input id="state.twitter" wire:model.defer="state.twitter" class="relative block w-full mt-2 pl-44 " type="text" name="state.twitter" />
        ...
        <div class="col-span-6 md:col-span-4">
            ...
            <div class="relative flex items-center">
                <x-jet-input id="state.youtube" wire:model.defer="state.youtube" class="relative block w-full mt-2 pl-44 " type="text" name="state.youtube" />
        ...
        <div class="col-span-6 md:col-span-4">
            ...
            <div class="relative flex items-center">
                <x-jet-input id="state.linkedin" wire:model.defer="state.linkedin" class="relative block w-full mt-2 pl-44 " type="text" name="state.linkedin" />
